...
export const Navbar = () => {
  ...
  const navbarHeight = "h-16"; // Define navbar height
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className={`flex items-center justify-between ${navbarHeight}`}>
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/forum" className="nav-link hover:opacity-80 transition-opacity px-3 py-2">
                Forum
              </Link>
              <Link href="/portfolios" className="nav-link hover:opacity-80 transition-opacity px-3 py-2">
                Portfolios
              </Link>
              <Link href="/about" className="nav-link hover:opacity-80 transition-opacity px-3 py-2">
                Hakkımızda
              </Link>
